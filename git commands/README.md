...
| ---------- | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `git init` | Initializes a new Git repository in the current directory. | `--bare`, `--template=<template_directory>`, `--separate-git-dir=<git_dir>`, `--shared[=permissions]`, `-q`, `--quiet` | `--bare`: Creates a repository without a working directory. <br> `--template=<template_directory>`: Copies templates from the specified directory. <br> `--separate-git-dir=<git_dir>`: Stores the `.git` directory in the specified path. <br> `--shared[=permissions]`: Sets sharing permissions like `group` or `all`. <br> `-q`, `--quiet`: Suppresses output for a quieter operation. |
