      ...
      <div className="container mt-4 flex flex-col items-center justify-center gap-4 overflow-hidden text-left xl:mt-14 xl:flex-row xl:overflow-visible">
        <div className="w-full space-y-10 xl:w-1/2">
          ...
          <p className="mt-3 max-w-lg text-muted-foreground/80">
            {description ||
              "Build dynamic marketing pages with Payload-backed content and production-ready shadcnblocks Pro sections."}
          </p>
            ...
            {secondaryLabel && secondaryHref ? (
              <Link
                className={cn(
                  ...
                  "group flex w-fit items-center justify-center gap-2 rounded-full px-4 py-1 tracking-tight",
                )}
                href={secondaryHref}
              >
