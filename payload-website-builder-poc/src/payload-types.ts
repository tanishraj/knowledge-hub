...
export interface Page {
  id: number;
  title: string;
  heroBackgroundColor?: ('background' | 'muted' | 'primary') | null;
  heroDesignVersion: 'hero231' | 'hero12' | 'hero18';
  ...
  layout: (FeatureBlock | TestimonialBlock | CallToActionBlock | FAQBlock)[];
